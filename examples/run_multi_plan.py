    ...
    def plan_sequence(self, path_planner_name, rotation, body_type, sdf_dx, collision_th, force_mag, frame_skip,
        ...
        while seq_count < self.max_seq_count:
            ...
            if record_dir is None:
                ...
                record_path = os.path.join(record_dir, f'{self.assembly_id}', f'{seq_count}_{still_ids}_{move_id}.gif')

            if save_dir is not None:
                curr_save_dir = os.path.join(save_dir, f'{self.assembly_id}', f'{seq_count}_{still_ids}_{move_id}')
            else:
                curr_save_dir = None

            print(f'{seq_count}_{still_ids}_{move_id}')
